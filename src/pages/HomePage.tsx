        ...
        <main className="flex-1">
          {status === 'idle' && (
            <div className="max-w-4xl mx-auto text-center space-y-10 py-12 md:py-20 animate-in fade-in zoom-in-95 duration-700">
              <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-emerald-50 text-emerald-600 text-[10px] font-bold uppercase tracking-widest border border-emerald-100 shadow-sm">
